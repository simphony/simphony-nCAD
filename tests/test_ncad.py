...
class NCadWrapperTestCase(unittest.TestCase):
    def setUp(self):
        self.ncad = ncad.nCad('test_ncad' + str(random.random()))
    ...
    def test_run(self):
        ...
        data = component.data
        data[CUBA.NAME_UC] = cell_name
        data[CUBA.SHAPE_TYPE] = SHAPE_TYPE.DIM_3D_BLOCK_UC
        data[CUBA.SHAPE_CENTER] = (0,0,0)
    ...
    def test_update_particle_container(self):
        ...
        self.assertItemsEqual(cur_data[CUBA.LATTICE_UC_ANGLES], (45,60,120))
        self.assertEqual(cur_data[CUBA.SYMMETRY_GROUP], SYMMETRY_GROUP.P213)
        ...
        cur_data[CUBA.SHAPE_TYPE] = SHAPE_TYPE.DIM_3D_CYLINDER
        ...
        cur_data = ncad_component.get_data()
        self.assertEqual(cur_data[CUBA.SHAPE_TYPE], SHAPE_TYPE.DIM_3D_CYLINDER)
        ...
        self.assertEqual(cur_data[CUBA.CRYSTAL_ORIENTATION_1], ((2,2,2),(1,0,1)))
        self.assertEqual(cur_data[CUBA.CRYSTAL_ORIENTATION_2], ((0,1,1),(1,1,0)))
        self.assertEqual(cur_data[CUBA.SHAPE_ORIENTATION_1], (AXIS_TYPE.Z,(1,0,1)))
        self.assertEqual(cur_data[CUBA.SHAPE_ORIENTATION_2], (AXIS_TYPE.X,(1,1,0)))


class NCadParticlesTestCase1(unittest.TestCase):
    def setUp(self):
        ncad_temp = ncad.nCad('test_ncad' + str(random.random()))
        self.ncad = ncad_temp
        options = {}
        options['type'] = 'cell'
