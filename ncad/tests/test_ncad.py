...
from ncad.auxiliar.ncad_types import SHAPE_TYPE, SYMMETRY_GROUP, AXIS_TYPE, CUBA_EXT
...
class NCadWrapperTestCase(unittest.TestCase):
    ...
    def test_add_particle_container(self):
        ...
        data[CUBA_EXT.SHAPE_TYPE] = SHAPE_TYPE.DIM_3D_SPHERE
        # optional:
    ...
    def test_run(self):
        ...
        data = DataContainerExt()
        data[CUBA.NAME_UC] = cell_name
        data[CUBA_EXT.SHAPE_TYPE] = SHAPE_TYPE.DIM_3D_BLOCK_UC
        data[CUBA.SHAPE_CENTER] = (0,0,0)
    ...
    def test_update_particle_container(self):
        ...
        cur_data[CUBA_EXT.SHAPE_TYPE] = SHAPE_TYPE.DIM_3D_CYLINDER
        ...
        cur_data = ncad_component.get_data()
        self.assertEqual(cur_data[CUBA_EXT.SHAPE_TYPE], SHAPE_TYPE.DIM_3D_CYLINDER)
